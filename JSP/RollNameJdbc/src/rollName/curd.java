...
public class curd {
	...
	public static void main(String[] args) {
		...
		// int test = update(9, "尧酱", 2011, 11, 11, 1);
	 ...
	 * @return
	 */
	public static int insert(int id, String username, int year, int month,
			int day, int isex) {
		if (month <= 12 && month >= 1 && day >= 1 && day <= 30) {
			...
			int i = writeDb(
					"INSERT INTO hehe_user(id,username,birthday,state) VALUES(?,?,?,?)",
					new Object[] { id, username, birthday, isex });
			return i;
		} else {
			return 0;
		}
