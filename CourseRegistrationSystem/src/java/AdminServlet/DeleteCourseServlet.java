...
public class DeleteCourseServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean i = deleteCourse(cid);

        if (i) {
            session.setAttribute("state", "删除一条课程基本信息.");
        } else {
            session.setAttribute("state", "删除课程基本信息失败.");
        }
    ...
    private boolean deleteCourse(int cid) {
