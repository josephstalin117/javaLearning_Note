<%-- 
    Document   : addCourse
    Created on : Jan 1, 2014, 6:46:27 PM
    Author     : josephstalin
--%>
        ...
        <div class="container">
            ...
            <div class="row row-offcanvas row-offcanvas-right">
                ...
                <div class="col-xs-12 col-sm-9">
                    ...
                    <div class="jumbotron">
                        <form role="form" action="../AddCourseServlet" method="post" class="form-horizontal">
                            <div class="form-group">
                                <label for="inputCid">课程号</label>
                                <input type="text" class="form-control" id="inputSid" placeholder="课程号" name="cid">
                            </div>
                            <div class="form-group">
                ...
                <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
                    <div class="list-group">
                        ...
                        <a href="getCourse.jsp" class="list-group-item">课程列表</a>
                        <a href="#" class="list-group-item active">添加课程</a>
